...
import lt.vpranckaitis.tranformSchool.matrices.OrthoMatrix.Data;
import lt.vpranckaitis.tranformSchool.matrices.TransferableData;

public class OrthoMatrixPanel extends AbstractMatrixPanel {

    /**
	 * 
	 */
    private static final long serialVersionUID = -1157267960735155827L;
    ...
    private JSpinner mSpin[]; // {Left, Right, Top, Bottom, Near, Far}

    public OrthoMatrixPanel() {
	super();
	...
	mSpin[4] = new JSpinner(new SpinnerNumberModel(0.1d, MIN, MAX, STEP));
	mSpin[5] = new JSpinner(new SpinnerNumberModel(VALUE, 0.1d, MAX, STEP));
	...
	return new OrthoMatrix.Data(v[0], v[1], v[2], v[3], v[4], v[5]);
    }

    @Override
    public void setData(TransferableData d) {
	if (d.getClass().equals(OrthoMatrix.Data.class)) {
	    setDataEventsDisabled(true);
	    OrthoMatrix.Data data = (OrthoMatrix.Data) d;
